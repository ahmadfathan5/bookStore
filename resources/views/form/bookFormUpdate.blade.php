...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <form action="/books/{{$buku->id}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" value="{{$buku->name}}">
            </div>
            <div class="mb-3">
                <label class="form-label">Release Year</label>
                <input type="date" name="year" class="form-control"value="{{$buku->year}}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="price" class="form-control" value="{{$buku->price}}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="file" name="cover" id="formFile" value="{{$buku->cover}}">
            </div>
